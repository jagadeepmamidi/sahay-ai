...
class ChatRequest(BaseModel):
    ...
    language: Optional[str] = Field("auto", description="Language code (auto for detection)")
...
class ChatResponse(BaseModel):
    ...
    suggested_questions: Optional[List[str]] = Field(None, description="Follow-up suggestions")
...
async def send_message(request: ChatRequest):
    ...
    try:
        ...
        return ChatResponse(
            success=True,
            message=result.get("response", "I apologize, I couldn't process your request."),
...
async def submit_feedback(request: FeedbackRequest):
    ...
    try:
        try:
            ...
            logger.info(f"Feedback stored: session={request.session_id}, rating={request.rating}")
