...
Keep responses concise but informative (2-4 paragraphs max)."""
    ...
    async def generate_response(
        ...
        try:
            ...
            context_text = "\n\n".join(context) if context else "No specific scheme information available."
    ...
    async def process(
        ...
        try:
            ...
            for doc in context[:3]:
                if doc.get("metadata", {}).get("scheme_id"):
                    schemes.append({
                        ...
                        "eligibility_summary": doc["metadata"].get("eligibility_summary", "")
                    })
            ...
            return {
                ...
                "confidence": 0,
                "schemes": [],
                "suggested_questions": ["What schemes am I eligible for?", "Tell me about PM-KISAN"],
                "session_id": session_id
            }
